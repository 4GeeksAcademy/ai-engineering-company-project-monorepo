...
[Construir un agente de IA que le recomiende a la empresa la mejor ruta disponible para ese paquete específico]
## Mi idea de Agente de IA
- Qué haría: [produciría la mejor ruta para que cada paquete llegue en el menor tiempo posible considerando si el paquete es el unico que viaja a ese destino,ver los vuelos comerciales,rutas,climatologia en tiempo real,alertas internacionales de demora en rutas comerciales para identificar potenciales factores de riesgo ó demora en la entrega del paquete,teniendo en cuenta el tiempo máximo esperado de entrega para ir evaluando la eficiencia de la ruta para evaluar si seguir usándola o cambiar a una más eficiente ya sea de forma permanente o temporal]
- Qué información necesitaría: [Necesitaria origen,destino,peso,dimensiones,sitema de referencia ya sea métria o imperial,clima,contexto internacional]
- Qué produciría o dispararía: [Generaría una ruta determinada para cada paquete y a la vez generaría su propio alimento estadístico para monitorear la efectividad de cada ruta en cada origen-destino].