...
- Qué produciría o dispararía: [podría disparar alertas a los consumidores sobre sus paquetes para que sepan si se retrasa o si se adelanta y por qué y generar reportes de todo lo sucedido para consumo propio de datos,estadisticas,problemas actuales,cantidades de paquetes en ruta,etc].